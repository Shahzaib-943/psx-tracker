@extends('layouts.app')
@section('page-title', 'Create Financial Category')
...
@section('content')
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Create Financial Category</h4>
                <form id="createFinanceCategoryForm" action="{{ route('finance-categories.store') }}" method="POST">
                    @csrf
                    <!-- Name Input -->
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="color" class="form-control color-input @error('color') is-invalid @enderror"
                            name="color" type="color" value="{{ old('color', '#000000') }}">
                        @error('color')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const toggleDropdown = () => {
                    if (isCommonCheckbox.checked) {
                        ...
                        // userSelectDropdown.value = ''; // Clear selection if checkbox is checked
                    } else {
