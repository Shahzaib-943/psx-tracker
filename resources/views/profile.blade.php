            ...
            <div class="card-body">
                ...
                <form class="forms-sample">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="exampleInputEmail1" readonly placeholder="Email" value="{{ $profile->email }}">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="exampleInputPassword1" readonly autocomplete="off"
                            placeholder="Role" value="{{ $profile->role}}">
                    </div>
